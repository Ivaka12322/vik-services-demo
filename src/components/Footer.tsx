...
export default function Footer() {
  ...
  return (
    <footer className="bg-sand pt-10 pb-6 relative overflow-hidden">
      <div className="container-wide px-4 relative z-10">
        <div className="bg-charcoal rounded-3xl p-8 md:p-10 mb-8 shadow-2xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-sand/70 text-sm font-medium leading-relaxed max-w-xs">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm font-bold uppercase tracking-wider">
                <li><a href="#services" className="text-sand/80 hover:text-teal transition-colors">Услуги</a></li>
                <li><a href="#about" className="text-sand/80 hover:text-teal transition-colors">За Нас</a></li>
                <li><a href="#pricing" className="text-sand/80 hover:text-teal transition-colors">Цени</a></li>
                <li><a href="#contact" className="text-sand/80 hover:text-teal transition-colors">Контакти</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm font-bold uppercase tracking-wider">
                <li className="text-sand/70">Цяла София</li>
                <li className="text-sand/70">office@vik-sofia.com</li>
              </ul>
            </div>
            ...
            <div className="flex flex-col lg:items-end">
              <div className="flex gap-4 mb-6">
                <a href="#" className="w-10 h-10 bg-teal/10 rounded-xl flex items-center justify-center text-teal hover:bg-teal hover:text-white transition-all">
              ...
              <div className="text-left lg:text-right">
                <p className="text-xs font-black uppercase tracking-widest text-white mb-2">ПОСЛЕДВАЙТЕ НИ</p>
                <p className="text-[10px] text-sand/60 font-medium uppercase tracking-widest leading-relaxed">
